# Generated by Django 4.1.1 on 2022-09-08 06:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firma_sprzedawca_save_nazwa', models.CharField(default='', editable=False, max_length=45)),
                ('firma_sprzedawca_save_nip', models.CharField(default='', editable=False, max_length=13)),
                ('firma_sprzedawca_save_ulica', models.CharField(default='', editable=False, max_length=45)),
                ('firma_sprzedawca_save_adres', models.TextField(default='', editable=False)),
                ('firma_klient_save_nazwa', models.CharField(default='', editable=False, max_length=45)),
                ('firma_klient_save_nip', models.CharField(default='', editable=False, max_length=13)),
                ('firma_klient_save_ulica', models.CharField(default='', editable=False, max_length=45)),
